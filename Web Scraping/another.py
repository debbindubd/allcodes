...
product_name_element = soup.find('a', {'class': 'RfADt'})
if product_name_element:
    product_name = product_name_element.text.strip()
else:
    product_name = "Unknown"

product_price = soup.find('span', {'class': 'ooOxS'})
if product_price:
    product_price = product_price.text.strip()
else:
    product_price = "Unknown"

product_rating = soup.find('span', {'class': 'qzqFw'})
if product_rating:
    product_rating = product_rating.text.strip()
else:
    product_rating = "Unknown"

product_sales = soup.find('span', {'class': '_1cEkb'})
if product_sales:
    product_sales = product_sales.find('span').text.strip()
else:
    product_sales = "Unknown"

product_image = soup.find('img', {'type': 'product'})
if product_image:
